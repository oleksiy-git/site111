...
function showHelpPage() {
  ...
  helpPageContent.innerHTML =
    '<p class="pop-logo">Help Page</p><p>Copyright 1986-2021. Oleksiy Onyshchenko. <br>Inspired by MS-DOS childhood.</p><p>Some text will be added here..</p><br><br><br><br><br><a href="#"><span id="close-help-page-btn" onclick="closeHelpPage()">[ Close this window ]</span></a>';
}
