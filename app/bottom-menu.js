...
function quitConfirmation() {
  ...
  quitPageContent.innerHTML =
    '<div class="top-path-label red-label">Exit</div><div><p>Are you sure that you want to exit?</p></div><br><span class="close-quit-page-btn">[ Yes ]</span><span> </span><span class="close-quit-page-btn" onclick="closeHelpPage()">[ No ]</span></div>';
}
